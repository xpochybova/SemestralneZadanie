...
{
    @SuppressLint("NewApi")
    public static String getRealPathFromURI_API19(Context context, Uri uri, boolean isVideo)
    {
    ...
    @SuppressLint("NewApi")
    public static String getRealPathFromURI_API11to18(Context context, Uri contentUri, boolean isVideo) {
    ...
    public static String getRealPathFromURI_BelowAPI11(Context context, Uri contentUri, boolean isVideo){
        String[] proj = { MediaStore.Images.Media.DATA };
        if (isVideo)
            proj = new String[]{MediaStore.Video.Media.DATA};
